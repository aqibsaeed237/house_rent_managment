...
public class ViewHouseAdapterOwner extends RecyclerView.Adapter<ViewHouseAdapterOwner.viewholder> {

    Context context;
    ArrayList<HouseModel> houseModelArrayList = new ArrayList<>();

    public ViewHouseAdapterOwner(Context context, ArrayList<HouseModel> houseModelArrayList) {
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHouseAdapterOwner.viewholder(view);
    }
