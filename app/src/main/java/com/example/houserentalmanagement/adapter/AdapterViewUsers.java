...
public class AdapterViewUsers extends RecyclerView.Adapter<AdapterViewUsers.viewholder> {
    Context context;
    ArrayList<mUser> arrayList = new ArrayList<>();
    String action;

    public AdapterViewUsers (Context context, ArrayList<mUser> userArrayList, String action) {
...
//        for delete user account on click item
//         uncomment the below code for deleting the user method check it null pointer exception found
...
//                });
//  }
//    private void showDialog(final mUser users) {
...
//                                            public void onComplete(@NonNull Task<Void> task) {
//                                                if (task.isSuccessful()) {
//                                                    Query fquery= FirebaseDatabase.getInstance().getReference().child(RegisterUser.USERS)
