...
public class RemoveHouseAdmin extends RecyclerView.Adapter<RemoveHouseAdmin.viewholder>{
    Context context;
    ArrayList<HouseModel> houseModelArrayList;


    public RemoveHouseAdmin(Context context, ArrayList<HouseModel> houseModelArrayList) {
    ...
    @NonNull
    @Override
    public RemoveHouseAdmin.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        @SuppressLint("InflateParams") View view = LayoutInflater.from(context).inflate(R.layout.viewhouse2, null, false);
        return new RemoveHouseAdmin.viewholder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull RemoveHouseAdmin.viewholder holder, @SuppressLint("RecyclerView") int position) {
