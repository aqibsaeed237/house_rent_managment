...
public class AddMember extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_addMember.setOnClickListener(v -> {
            if (et_memberName.getText().toString().isEmpty()) {
                et_memberName.setError("Enter Name");

            } else if (et_memberAge.getText().toString().isEmpty()) {
                et_memberAge.setError("Enter Age");
            } else if (et_memberJob.getText().toString().isEmpty()) {
                et_memberJob.setError("Enter member job");
            } else if (et_memberRent.getText().toString().isEmpty()) {
                et_memberRent.setError("Enter member rent");
            } else if (et_memberJoiningDate.getText().toString().isEmpty()) {
                et_memberJoiningDate.setError("Enter Joining date");
            } else if (et_memberPhoneNumber.getText().toString().isEmpty()) {
                et_memberPhoneNumber.setError("Enter phone number");
