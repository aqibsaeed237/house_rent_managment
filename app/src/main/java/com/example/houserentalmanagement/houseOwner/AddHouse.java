...
public class AddHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_addHouse.setOnClickListener(v -> {
            if (et_houseId.getText().toString().isEmpty()) {
                et_houseId.setError("Enter Id name for house");

            } else if (et_houseLocation.getText().toString().isEmpty()) {
                et_houseLocation.setError("Enter Age");
            } else if (et_noOfRoom.getText().toString().isEmpty()) {
                et_noOfRoom.setError("Enter member job");
            } else if (et_houseDescription.getText().toString().isEmpty()) {
                et_houseDescription.setError("Enter member rent");
            } else if (btn_addHouse.getText().toString().isEmpty()) {
                btn_addHouse.setError("Enter Joining date");
            } else if (iv_houseImage.getDrawable() == null) {
                Toast.makeText(AddHouse.this, "Put Image of House", Toast.LENGTH_SHORT).show();
    ...
    private void createFood(String houseId, String houseLocation, String noOfRoom, String rentPerRoom, String houseDescription, String image) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                .child(RegisterOwner.HOUSES).child(userId);
        HashMap<String, String> hashMap = new HashMap<>();

        // key get the refrence
